    ...
    <section id="contact" className="py-24 mb-12">
      ...
      >
        ...
        <div className="glass-card p-8 md:p-12 border border-surface-3 relative overflow-hidden">
          {/* Hidden Iframe to handle cross-origin submission without redirects or CORS blocks */}
          <iframe 
            name="hidden_iframe" 
            id="hidden_iframe" 
            style={{ display: 'none' }} 
          ...
          {/* Form */}
          <form 
            action="https://formsubmit.co/sikalundumwinga@gmail.com" 
            method="POST" 
          ...
          >
            ...
            <input type="hidden" name="_subject" value={`🌌 Sikkalundu Portfolio: New Message from ${name}`} />
